...
export function buildAnalysisPrompt(purpose: string, index: string, sourceContent: string = ""): string {
  return [
    ...
    "",
    "## Diagram and Flow Captions",
    "If the source contains image captions for flowcharts, architecture diagrams, sequence diagrams, swimlane diagrams, knowledge graphs, or full-page screenshots, preserve their graph structure in the analysis. Do not reduce them to a generic one-sentence summary. Capture nodes, directed edges, branches/conditions, inputs/outputs, and groups/swimlanes when visible.",
    "",
...
export function buildGenerationPrompt(
  ...
  return [
    ...
    "- For flowcharts, architecture diagrams, sequence diagrams, swimlane diagrams, knowledge graphs, and full-page screenshot captions, include a visible graph-structure description in the relevant page body. Preserve nodes, directed edges, branches/conditions, inputs/outputs, and groups/swimlanes when visible; do not leave this information only inside image alt text.",
